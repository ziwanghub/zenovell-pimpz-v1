...
export function ProductFinalCta({ product }: ProductFinalCtaProps) {
  ...
  return (
    <section id="line-cta" className="px-4 py-4 text-white md:px-0">
      <div className="mx-auto max-w-[430px] overflow-hidden rounded-[28px] border border-fuchsia-500/18 bg-[radial-gradient(circle_at_top,_rgba(236,72,153,0.18),_transparent_40%),linear-gradient(180deg,rgba(20,11,26,0.98),rgba(8,5,11,0.98))] p-5 shadow-[0_20px_54px_rgba(0,0,0,0.38)]">
